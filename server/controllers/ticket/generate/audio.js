...
// Capture the original ML department name
const originalDept = department;

// Map ML expanded names to the short department names in the database for lookup
...
// Check if the department exists before proceeding
if (!dep) {
...
return res.status(201).json({
  ...
  ticket: {
    ticketID: ticket.ticketID,
    type: "audio",
    department: originalDept, // use the full ML string here
